...
Manager::schema()->create('staff', function (Blueprint $table) {
    ...
    $table->timestamps();
    $table->foreign('job_id')->references('jobid')->on('job')->onDelete('cascade');
});
...
Manager::schema()->create('product', function (Blueprint $table) {
    ...
    $table->timestamps();
    $table->foreign('cust_id')->references('user_id')->on('customer')->onDelete('cascade');
    $table->foreign('part_id')->references('id')->on('repairPart')->onDelete('cascade');
});
